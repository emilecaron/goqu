...
| (_| | (_) | (_| | |_| |
 ...
 |___/          |_|
```
[![GitHub tag](https://img.shields.io/github/tag/emilecaron/goqu.svg?style=flat)](https://github.com/emilecaron/goqu/releases)
[![Test](https://github.com/emilecaron/goqu/workflows/Test/badge.svg?branch=master&event=push)](https://github.com/emilecaron/goqu/actions?query=workflow%3ATest+and+branch%3Amaster+)
[![Go Reference](https://pkg.go.dev/badge/github.com/emilecaron/goqu/v9.svg)](https://pkg.go.dev/github.com/emilecaron/goqu/v9)
[![codecov](https://codecov.io/gh/emilecaron/goqu/branch/master/graph/badge.svg)](https://codecov.io/gh/emilecaron/goqu)
[![Go Report Card](https://goreportcard.com/badge/github.com/emilecaron/goqu/v9)](https://goreportcard.com/report/github.com/emilecaron/goqu/v9)
...
```sh
go get -u github.com/emilecaron/goqu/v9
```

If you are not using go modules...

**NOTE** You should still be able to use this package if you are using go version `>v1.10` but, you will need to drop the version from the package. `import "github.com/emilecaron/goqu/v9` -> `import "github.com/emilecaron/goqu"`

```sh
go get -u github.com/emilecaron/goqu
```
...
### Running tests
The test suite requires a postgres, mysql and sqlserver databases. You can override the connection strings with the [`MYSQL_URI`, `PG_URI`, `SQLSERVER_URI` environment variables](https://github.com/emilecaron/goqu/blob/2fe3349/docker-compose.yml#L26)*
