...
<a name="create"></a>
To create a [`SelectDataset`](https://godoc.org/github.com/emilecaron/goqu/#SelectDataset)  you can use

**[`goqu.From`](https://godoc.org/github.com/emilecaron/goqu/#From) and [`goqu.Select`](https://godoc.org/github.com/emilecaron/goqu/#Select)**
...
**[`DialectWrapper.From`](https://godoc.org/github.com/emilecaron/goqu/#DialectWrapper.From) and [`DialectWrapper.Select`](https://godoc.org/github.com/emilecaron/goqu/#DialectWrapper.Select)**

Use this when you want to create SQL for a specific `dialect`

```go
// import _ "github.com/emilecaron/goqu/v9/dialect/mysql"
...
**[`Database.From`](https://godoc.org/github.com/emilecaron/goqu/#DialectWrapper.From) and [`Database.Select`](https://godoc.org/github.com/emilecaron/goqu/#DialectWrapper.From)**
...
For more examples visit the **[Docs](https://godoc.org/github.com/emilecaron/goqu/#SelectDataset)**

<a name="select"></a>
**[`Select`](https://godoc.org/github.com/emilecaron/goqu/#SelectDataset.Select)**
...
<a name="distinct"></a>
**[`Distinct`](https://godoc.org/github.com/emilecaron/goqu/#SelectDataset.Distinct)**
...
<a name="from"></a>
**[`From`](https://godoc.org/github.com/emilecaron/goqu/#SelectDataset.From)**
...
<a name="joins"></a>
**[`Join`](https://godoc.org/github.com/emilecaron/goqu/#SelectDataset.Join)**
...
[`InnerJoin`](https://godoc.org/github.com/emilecaron/goqu/#SelectDataset.InnerJoin)
...
[`FullOuterJoin`](https://godoc.org/github.com/emilecaron/goqu/#SelectDataset.FullOuterJoin)
...
[`RightOuterJoin`](https://godoc.org/github.com/emilecaron/goqu/#SelectDataset.RightOuterJoin)
...
[`LeftOuterJoin`](https://godoc.org/github.com/emilecaron/goqu/#SelectDataset.LeftOuterJoin)
...
[`FullJoin`](https://godoc.org/github.com/emilecaron/goqu/#SelectDataset.FullJoin)
...
[`RightJoin`](https://godoc.org/github.com/emilecaron/goqu/#SelectDataset.RightJoin)
...
[`LeftJoin`](https://godoc.org/github.com/emilecaron/goqu/#SelectDataset.LeftJoin)
...
[`NaturalJoin`](https://godoc.org/github.com/emilecaron/goqu/#SelectDataset.NaturalJoin)
...
[`NaturalLeftJoin`](https://godoc.org/github.com/emilecaron/goqu/#SelectDataset.NaturalLeftJoin)
...
[`NaturalRightJoin`](https://godoc.org/github.com/emilecaron/goqu/#SelectDataset.NaturalRightJoin)
...
[`NaturalFullJoin`](https://godoc.org/github.com/emilecaron/goqu/#SelectDataset.NaturalFullJoin)
...
[`CrossJoin`](https://godoc.org/github.com/emilecaron/goqu/#SelectDataset.CrossJoin)
...
<a name="where"></a>
**[`Where`](https://godoc.org/github.com/emilecaron/goqu/#SelectDataset.Where)**
...
<a name="limit"></a>
**[`Limit`](https://godoc.org/github.com/emilecaron/goqu/#SelectDataset.Limit)**
...
<a name="offset"></a>
**[`Offset`](https://godoc.org/github.com/emilecaron/goqu/#SelectDataset.Offset)**
...
<a name="group_by"></a>
**[`GroupBy`](https://godoc.org/github.com/emilecaron/goqu/#SelectDataset.GroupBy)**
...
<a name="having"></a>
**[`Having`](https://godoc.org/github.com/emilecaron/goqu/#SelectDataset.Having)**
...
<a name="with"></a>
**[`With`](https://godoc.org/github.com/emilecaron/goqu/#SelectDataset.With)**
...
<a name="window"></a>
**[`Window Function`](https://godoc.org/github.com/emilecaron/goqu/#SelectDataset.Window)**
...
<a name="seterror"></a>
**[`SetError`](https://godoc.org/github.com/emilecaron/goqu/#SelectDataset.SetError)**
...
<a name="forupdate"></a>
**[`ForUpdate`](https://godoc.org/github.com/emilecaron/goqu/#SelectDataset.ForUpdate)**
...
To execute your query use [`goqu.Database#From`](https://godoc.org/github.com/emilecaron/goqu/#Database.From) to create your dataset

<a name="scan-structs"></a>
**[`ScanStructs`](http://godoc.org/github.com/emilecaron/goqu#SelectDataset.ScanStructs)**

Scans rows into a slice of structs

**NOTE** [`ScanStructs`](http://godoc.org/github.com/emilecaron/goqu#SelectDataset.ScanStructs) will only select the columns that can be scanned in to the structs unless you have explicitly selected certain columns.
...
**[`ScanStruct`](http://godoc.org/github.com/emilecaron/goqu#SelectDataset.ScanStruct)**

Scans a row into a slice a struct, returns false if a row wasnt found

**NOTE** [`ScanStruct`](http://godoc.org/github.com/emilecaron/goqu#SelectDataset.ScanStruct) will only select the columns that can be scanned in to the struct unless you have explicitly selected certain columns.
...
<a name="scan-vals"></a>
**[`ScanVals`](http://godoc.org/github.com/emilecaron/goqu#SelectDataset.ScanVals)**
...
<a name="scan-val"></a>
[`ScanVal`](http://godoc.org/github.com/emilecaron/goqu#SelectDataset.ScanVal)
...
<a name="scanner"></a>
**[`Scanner`](http://godoc.org/github.com/emilecaron/goqu/exec#Scanner)**
...
<a name="count"></a>
**[`Count`](http://godoc.org/github.com/emilecaron/goqu#SelectDataset.Count)**
...
<a name="pluck"></a>
**[`Pluck`](http://godoc.org/github.com/emilecaron/goqu#SelectDataset.Pluck)**
